...
import com.example.monitorbudimas.Adapter.RecyclerMobil;
...
public class Ongoing extends Fragment{
    ...
    public static Ongoing getInstance() {
        return new Ongoing();
    }
    ...
    private RecyclerMobil adDatao;
    private final List<mobil> itemo = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView = view.findViewById(R.id.viewo);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        adDatao = new RecyclerMobil(getActivity(), itemo);
        recyclerView.setAdapter(adDatao);
        retrievedata();
        return view;
    }
    ...
    public void retrievedata() {
        ...
        Call<responseMobil> tampilData = ardData.ardretrievemobil();
        ...
        tampilData.enqueue(new Callback<responseMobil>() {
            ...
            public void onResponse(Call<responseMobil> call, Response<responseMobil> response) {
               ...
               // Toast.makeText(getContext(), "" + pesan, Toast.LENGTH_SHORT).show();
                final List<com.example.monitorbudimas.Model.mobil.mobil> itemmobillist = response.body().getData();

                if (itemmobillist != null) {
                    itemo.addAll(itemmobillist);
                    adDatao.notifyDataSetChanged();
                }else{
                    Toast.makeText(getContext(), "Tidak ada mobil", Toast.LENGTH_SHORT).show();
                }
            }
